...
@testset "IndexAffineTransform" begin
    @test @inferred(IndexAffineTransform(axisrotate((1,0,0),.01))) isa IndexAffineTransform{3,ATINEH.AffineTransform{3,StaticArrays.SMatrix{3,3,Float64,9},StaticZeroVector{3}}}
