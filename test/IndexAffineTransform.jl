...
@testset "IndexAffineTransform" begin
    @test isa(@inferred(IndexAffineTransform{3}(axisrotate((1,0,0),.01))), IndexAffineTransform{3,ATINEH.AffineTransform{3,StaticArrays.SMatrix{3,3,Float64,9},StaticArrays.SVector{3,Float64}}})
    @test isa(@inferred(IndexAffineTransform(axisrotate((1,0,0),.01))), IndexAffineTransform{3,ATINEH.AffineTransform{3,StaticArrays.SMatrix{3,3,Float64,9},StaticArrays.SVector{3,Float64}}})
