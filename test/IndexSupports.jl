...
@testset "IndexSupport" begin
    ...
    @test FlatIndexReturningArray((3,4,5))[ConstantExterior{3}(), 2,2,2] == (ATINEH.FlatIndexSupportPoint(1.0, 17),)
    @test FlatIndexReturningArray((3,4,5))[ConstantExterior{3}(), -2,2,2] == Tuple{ATINEH.FlatIndexSupportPoint{Float64,Int64}}(0)
